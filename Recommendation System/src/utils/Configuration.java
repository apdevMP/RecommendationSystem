...
public class Configuration {
	...
	/**
	 * @param mongo_server_address
	 *            the mongo_server_address to set
	 */
	...
	/**
	 * @param municipalities_collection
	 *            the municipalities_collection to set
	 */
	...
	/**
	 * @param school_collection
	 *            the school_collection to set
	 */
	...
	/**
	 * @param watches_collection
	 *            the watches_collection to set
	 */
	...
	/**
	 * @param profile_collection
	 *            the profile_collection to set
	 */
	...
	/**
	 * @param neo_server_address
	 *            the neo_server_address to set
	 */
	...
	public String toString() {
		return "Configuration [getMongo_server_address()="
				...
				+ getWatches_collection() + ", getProfile_collection()="
				+ getProfile_collection() + ", getNeo_username()="
