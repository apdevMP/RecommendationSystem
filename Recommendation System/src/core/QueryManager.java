...
public class QueryManager
{
	 ...
	 * trasferiti da quella scuola ce ne sono alcuni con score relazionabile a quello dell'utente
	 * 
	 * @return true se la scuola prevede trasferimenti in uscita con score minore o uguale a quello dell'utente
	 * @throws SQLException
	 */
	...
	{
		FindIterable<Document> iterable = manager.findWatches(index);
		return iterable;
	}

	public FindIterable<Document> getLogsByAction(String[] actions, int index)
	{
		FindIterable<Document> iterable = manager.findLogsByAction(actions, index);
		return iterable;
	}
